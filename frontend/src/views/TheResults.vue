  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Q. Respondidas", value: "qRespondidas", class: "subtitle-2" },
        { text: "Q. Corretas", value: "qCertas", class: "subtitle-2" },
        { text: "Classificação", value: "classificacao", class: "subtitle-2" },
